  ...
  return (
    <div className='Coaches-container'>
      <div className='content'>
        ...
        <p className='texts'>Our experienced coaches provide personalized <span className='color'>one-on-one </span> lessons as well as  <span className='color'>group lessons </span> for two or more players to improve your padel skills and enhance your game. Whether you're a <span className='color'>beginner</span> or an <span className='color'>advanced</span> player, we have the expertise to help you reach your full potential.</p>
